                    ...
                    <div className="grid grid-cols-[152px_444px_600px] items-center">
                        <div className="flex flex-col">
                            <div className="w-[152px] h-[167px] rounded-[20px] mb-[14px]">
                                <img src={Sample1} alt="sample1" className="h-full w-full object-cover rounded-[20px]" />
                            </div>
                            <div className="w-[152px] h-[167px] rounded-[20px] mb-[14px]">
                            <img src={Sample2} alt="sample2" className="h-full w-full object-cover rounded-[20px]" />
                            </div>
                            <div className="w-[152px] h-[167px] rounded-[20px] mb-[14px]">
                            <img src={Sample3} alt="sample3" className="h-full w-full object-cover rounded-[20px]" />
                            </div>
                        </div>
                        <div className="h-[530px] w-full rounded-[20px] ml-[14px]">
                                <img src={Sample4} alt="sample4" className="h-full w-full object-cover" />
                        </div>
                        <div className="ml-10">
                            ...
                            <div className="flex flex-row items-center font-fontShare text-[32px] font-bold">
                                ...
                                <span className="h-[34px] w-[72px] rounded-[62px] bg-[#ff33331a] flex justify-center items-center text-[#F33] text-base font-medium">-40%</span>
                            </div>
                            ...
                            <div className="after:content-'' after:table after:h-[1px] after:w-full after:bg-[#0000001a] after:mt-6 mt-6">
                                <h4 className="text-[#00000099] text-base font-normal font-fontShare capitalize mb-4">Select Colors</h4>
                            ...
                            <div className="after:content-'' after:table after:h-[1px] after:w-full after:bg-[#0000001a] after:mt-6 mt-6">
                                <h4 className="text-[#00000099] text-base font-normal font-fontShare capitalize mb-4">Choose Size</h4>
                                <div className="flex flex-row">
                                    <span className="py-3 px-6 bg-[#F0F0F0] rounded-[62px] capitalize text-[#00000099] text-base font-fontShare font-normal leading-normal mr-3">small</span>
                                    <span className="py-3 px-6 bg-[#F0F0F0] rounded-[62px] capitalize text-[#00000099] text-base font-fontShare font-normal leading-normal mr-3">medium</span>
                                    <span className="py-3 px-6 bg-[#F0F0F0] rounded-[62px] capitalize text-[#00000099] text-base font-fontShare font-normal leading-normal mr-3">large</span>
                                    <span className="py-3 px-6 bg-[#F0F0F0] rounded-[62px] capitalize text-[#00000099] text-base font-fontShare font-normal leading-normal mr-3">x-large</span>
                                </div>
                            </div>
