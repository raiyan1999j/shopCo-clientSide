                    ...
                    <div className="grid grid-cols-4 gap-x-[21px]">
                        <div className="w-[296px]">
                            <div className="w-full h-[298px] rounded-[20px]">
                                <img src={Related1} alt="relatedProducts1" className="h-full w-full object-cover rounded-[20px]"/>
                            </div>
                            <div className="mt-4">
                        ...
                        <div className="w-[296px]">
                            <div className="w-full h-[298px] rounded-[20px]">
                                <img src={Related2} alt="relatedProducts2" className="h-full w-full object-cover rounded-[20px]"/>
                            </div>
                            <div className="mt-4">
                                <h2 className="text-black font-fontShare text-xl font-bold leading-normal">
                                Polo with Contrast Trims
                        ...
                        <div className="w-[296px]">
                            <div className="w-full h-[298px] rounded-[20px]">
                                <img src={Related3} alt="relatedProducts3" className="h-full w-full object-cover rounded-[20px]"/>
                            </div>
                            <div className="mt-4">
                                <h2 className="text-black font-fontShare text-xl font-bold leading-normal">
                                Polo with Contrast Trims
                        ...
                        <div className="w-[296px]">
                            <div className="w-full h-[298px] rounded-[20px]">
                                <img src={Related4} alt="relatedProducts4" className="h-full w-full object-cover rounded-[20px]"/>
                            </div>
                            <div className="mt-4">
                                <h2 className="text-black font-fontShare text-xl font-bold leading-normal">
                                Polo with Contrast Trims
